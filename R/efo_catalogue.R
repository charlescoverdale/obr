...
efo_catalogue_table <- function() {
  ...
  rows <- list(
    ...
    list("6.4",  "aggregates", "Aggregates",  "Public sector transactions by sub-sector and economic category",    "complex_layout",   NA, NA_character_),
    ...
    list("6.10", "aggregates", "Students",    "Proxy for prevailing market rates (student loan interest cap)",      "complex_layout",   NA,    NA_character_),
